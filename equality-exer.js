...
function findAll(match, arr) {
	var retArr = [];
	for (let a of arr) {
		if (Object.is(match, a)) {
			retArr.push(a)
		}
		else if (match == null && a == null) {
			retArr.push(a)
		}
		else if (typeof match == "boolean" && typeof a == "boolean") {
			if (match == a) {
				retArr.push(a)
			}
		}
		else if (typeof match == "string" && match.trim() != "" && typeof a == "number" && !Object.is(a, -0)) {
			if (match == a) {
				retArr.push(a);
			}
		}
